...
class Frieze:
    def __init__(self, frieze_name = None):
        ...
        is_correct_input = self.is_number_of_line_correct()
        is_correct_freize =  self.find_period() >= 2 and self.is_intersection() and self.is_format_correct()
        if is_correct_input:
    ...
    def is_intersection(self):
        for line in range(1,len(self.codes_of_frieze) - 1):
    ...
    def find_period(self):
        ...
        #print(period_list)
        if period_list:
            if len(period_list) != len(self.codes_of_frieze):
                return False
        ...
        for i in range(period):
            ...
            for e in range(0, len(self.codes_of_frieze[0]) // period):
                ...
                if (i + e * period) > len(self.codes_of_frieze[0]) // 2:
                    ...
                    for row in range(len(self.codes_of_frieze)):
                        for col in range(0, i + e * period + 1):
                            if self.codes_of_frieze[row][col].direction[1] != 0:
                                if self.codes_of_frieze[row][(i + e * period) * 2 + 1 - col].direction[1] == 0:
                                    can_pass_test = False
                                    break
                    ...
                    if can_pass_test:
                        count_pass_e += 1
            if count_e == count_pass_e and count_e > 1:
                #print('You are verticle relective')
                #print(f'1 {i} is symmetry axis,{count_e}')
                return True
        ...
        for i in range(period + 1):
            ...
            for e in range(0, len(self.codes_of_frieze[0]) // period):
                ...
                if (i + e * period) >= len(self.codes_of_frieze[0]) // 2:
                    ...
                    if can_pass_test:
                        count_pass_e += 1
            if count_pass_e == count_e and count_e > 1:
                #print(count_e)
                is_valid_axis = True
                break
        if is_valid_axis:
            #print(f'2 {i} is symmetry axis')
            return True
        else:
            return False
        ...
        if len(self.codes_of_frieze) % 2 == 0:
                ...
                for e in range(0, len(self.codes_of_frieze[0]) // period):
                    ...
                    if (i + e * period) > len(self.codes_of_frieze[0]) // 2:
                        ...
                        for row in range(len(self.codes_of_frieze)):
                            for col in range(0, i + e * period + 1):
                                if self.codes_of_frieze[row][col].direction[1] != 0:
                                    if self.codes_of_frieze[tail_num - row + 1][(i + e * period) * 2 + 1 - col].direction[1] == 0:
                                        # print(f'{i}+{e} on (row{row},col{col}) Error happens at direction [1]' )
                                        can_pass_test = False
                                        break
                                if self.codes_of_frieze[row][col].direction[4] != 0:
                                    if self.codes_of_frieze[tail_num - row][(i + e * period) * 2 - col].direction[4] == 0:
                                        # print(f'{i}+{e} on (row{row},col{col}) Error happens at direction [4]' )
                                        can_pass_test = False
                                        break
                                if self.codes_of_frieze[row][col].direction[2] != 0:
                                    if self.codes_of_frieze[tail_num - row + 1][(i + e * period) * 2 - col].direction[2] == 0:
                                        # print(f'{i}+{e} on (row{row},col{col}) Error happens at direction [2]' )
                                        can_pass_test = False
                                        break
                                if self.codes_of_frieze[row][col].direction[8] != 0:
                                    if self.codes_of_frieze[tail_num - row - 1][(i + e * period) * 2 - col].direction[8] == 0:
                                        # print(f'{i}+{e} on (row{row},col{col}) Error happens at direction [8]' )
                                        can_pass_test = False
                                        break
                        if can_pass_test:
                            count_pass_e += 1
                if count_pass_e == count_e and count_pass_e > 1:
                    #print(f'the rotation point is at {i}')
                    return True
            ...
            for i in range(period + 1):
                ...
                for e in range(0, len(self.codes_of_frieze[0]) // period):
                    ...
                    if (i + e * period) > len(self.codes_of_frieze[0]) // 2:
                        ...
                        for row in range(len(self.codes_of_frieze)):
                            if self.codes_of_frieze[row][i + e * period].direction[4] != 0:
                                if self.codes_of_frieze[tail_num - row][i + e * period - 1].direction[4] == 0:
                                    can_pass_test = False
                                    break
                            if self.codes_of_frieze[row][i + e * period].direction[2] != 0:
                                if self.codes_of_frieze[tail_num - row + 1][i + e * period - 1].direction[2] == 0:
                                    can_pass_test = False
                                    break
                            if self.codes_of_frieze[row][i + e * period].direction[8] != 0:
                                if self.codes_of_frieze[tail_num - row - 1][i + e * period - 1].direction[8] == 0:
                                    can_pass_test = False
                                    break
                        for row in range(len(self.codes_of_frieze)):
                            for col in range(i + e * period):
                                if self.codes_of_frieze[row][col].direction[1] != 0:
                                    if self.codes_of_frieze[tail_num - row + 1][(i + e * period) * 2 - col].direction[1] == 0:
                                        can_pass_test = False
                                        break
                                if self.codes_of_frieze[row][col].direction[4] != 0:
                                    if self.codes_of_frieze[tail_num - row][(i + e * period) * 2 - col - 1].direction[4] == 0:
                                        can_pass_test = False
                                        break
                                if self.codes_of_frieze[row][col].direction[2] != 0:
                                    if self.codes_of_frieze[tail_num - row + 1][(i + e * period) * 2 - col - 1].direction[2] == 0:
                                        can_pass_test = False
                                        break
                                if self.codes_of_frieze[row][col].direction[8] != 0:
                                    if self.codes_of_frieze[tail_num - row - 1][(i + e * period) * 2 - col - 1].direction[8] == 0:
                                        can_pass_test = False
                                        break
                        if can_pass_test:
                            count_pass_e += 1
            ...
            for i in range(period + 1):
                ...
                for e in range(0, len(self.codes_of_frieze[0]) // period):
                    ...
                    can_pass_test = True
                    for col in range(i + e * period):
                        if self.codes_of_frieze[sys_axis][col].direction[2] == 0 and \
                                self.codes_of_frieze[sys_axis + 1][(i + e * period) * 2 - col].direction[2] != 0:
                            #print(f'HA{sys_axis},{i},{e} {col} is wrong,at 2')
                            can_pass_test = False
                            break
                        elif self.codes_of_frieze[sys_axis][col].direction[8] != 0 and \
                                self.codes_of_frieze[sys_axis - 1][(i + e * period) * 2 - col].direction[8] == 0:
                            #print(f'HA{sys_axis},{i},{e} {col} is wrong,at 8(case 2.1)')
                            can_pass_test = False
                            break
                        else:
                            pass
                        if self.codes_of_frieze[sys_axis][col].direction[1] != 0:
                            if self.codes_of_frieze[sys_axis + 1][(i + e * period) * 2 + 1 - col].direction[1] == 0:
                                #print(f'HA{sys_axis},{i},{e} {col} is wrong at 1')
                                can_pass_test = False
                                break
                        ##Symmetry Test
                    for row in range(len(self.codes_of_frieze)):
                        for col in range(0, i + e * period + 1):
                            if self.codes_of_frieze[row][col].direction[1] != 0:
                                if self.codes_of_frieze[tail_num - row + 1][(i + e * period) * 2 - col + 1].direction[1] == 0:
                                    #print(f'{i}+{e} on (row{row},col{col}) Error happens at direction [1]' )
                                    can_pass_test = False
                                    break
                            if self.codes_of_frieze[row][col].direction[4] != 0:
            ...
            for i in range(period + 1):
                ...
                for e in range(0, len(self.codes_of_frieze[0]) // period):
                    ...
                    for col in range(i + e * period):
                        if self.codes_of_frieze[sys_axis][col].direction[2] == 0 and \
                                self.codes_of_frieze[sys_axis + 1][(i + e * period) * 2 - col - 1].direction[2] != 0:
                            #print(f'HA{sys_axis},{i},{e} {col} is wrong ,at 2')
                            can_pass_test = False
                            break
                        elif self.codes_of_frieze[sys_axis][col].direction[8] != 0 and \
                                self.codes_of_frieze[sys_axis - 1][(i + e * period) * 2 - col - 1].direction[8] == 0:
                            #print(f'HA{sys_axis},{i},{e} {col} is wrong, at 8(case 2.2)')
                            can_pass_test = False
                            break
                        else:
                            pass
                        if self.codes_of_frieze[sys_axis][col].direction[1] != 0:
                            if self.codes_of_frieze[sys_axis + 1][(i + e * period) * 2 - col].direction[1] == 0:
                                #print(f'HA{sys_axis},{i},{e} {col} is wrong, at 1')
                                can_pass_test = False
                                break
                    for row in range(len(self.codes_of_frieze)):
                        if self.codes_of_frieze[row][i + e * period].direction[4] != 0:
                            if self.codes_of_frieze[tail_num - row][i + e * period - 1].direction[4] == 0:
                                #print(f'VA{sys_axis},{i},{e} {col} is wrong, at 4')
                                can_pass_test = False
                                break
                        if self.codes_of_frieze[row][i + e * period].direction[2] != 0:
                            if self.codes_of_frieze[tail_num - row + 1][i + e * period - 1].direction[2] == 0:
                                #print(f'VA{sys_axis},{i},{e} {col} is wrong, at 2')
                                can_pass_test = False
                                break
                        if self.codes_of_frieze[row][i + e * period].direction[8] != 0:
                            if self.codes_of_frieze[tail_num - row - 1][i + e * period - 1].direction[8] == 0:
                                #print(f'VA{sys_axis},{i},{e} {col} is wrong, at 8')
                                can_pass_test = False
                                break
                    for row in range(len(self.codes_of_frieze)):
                        for col in range(i + e * period):
            ...
            if is_valid_axis:
                ...
                #print(count_e,'case 2')
                return False
    

    def analyse(self):
        is_rr = self.is_rotation()
        is_hr = self.is_horizental_reflection()
        is_vr = self.is_verticle_reflection()
        is_ghr = self.is_glided_horizental_reflection()
        if is_hr == False and is_ghr == False and is_rr == False and is_vr == False:
            print(f'Pattern is a frieze of period {self.find_period()} that is invariant under translation only.')
        elif is_hr == False and is_ghr == False and is_rr == False and is_vr:
            print(f'Pattern is a frieze of period {self.find_period()} that is invariant under translation\n        and vertical reflection only.')
        elif is_hr and is_ghr == False and is_rr == False and is_vr == False:
            print(f'Pattern is a frieze of period {self.find_period()} that is invariant under translation\n        and horizontal reflection only.')
        elif is_hr == False and is_ghr and is_rr == False and is_vr == False:
            print(f'Pattern is a frieze of period {self.find_period()} that is invariant under translation\n        and glided horizontal reflection only.')
        elif is_hr == False and is_ghr == False and is_rr and is_vr == False:
            print(f'Pattern is a frieze of period {self.find_period()} that is invariant under translation\n        and rotation only.')
        elif is_hr == False and is_ghr and is_rr and is_vr:
            print(f'Pattern is a frieze of period {self.find_period()} that is invariant under translation,\n        glided horizontal and vertical reflections, and rotation only.')
        elif is_hr and is_ghr == False and is_rr and is_vr:
